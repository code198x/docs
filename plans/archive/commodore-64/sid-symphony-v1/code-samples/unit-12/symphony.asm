; ============================================================================
; SID Symphony - Unit 12: Hit Detection
; ============================================================================
; Detecting when key presses match notes in the hit zone:
; - Check if note is in hit zone when key pressed
; - Play the correct SID note on successful hit
