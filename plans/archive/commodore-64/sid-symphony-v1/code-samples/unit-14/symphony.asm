; ============================================================================
; SID Symphony - Unit 14: Health Meter
; ============================================================================
; Adding a health/performance meter:
; - Health bar displayed at bottom of screen
; - Health increases on hits, decreases on misses
; - Game over when health reaches zero
; - Visual feedback through bar graph display
; ============================================================================
