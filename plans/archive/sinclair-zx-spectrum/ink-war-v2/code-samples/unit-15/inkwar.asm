; Ink War - Unit 15: Play Again
; Add visual feedback for restarting and smooth transitions
;
; Learning objectives:
; - Add flashing prompt for visual feedback
; - Create smooth state transitions
; - Reset game state completely
; - Handle game loop restart cleanly
