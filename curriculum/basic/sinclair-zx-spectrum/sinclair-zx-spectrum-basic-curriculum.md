...
> **v6.4 in progress (2026-05-19).** v6.4 is a *rename pass* on v6.3 — 11 games using canonical / trademarked names get inspired-by replacements per the [inspired-by-not-clones naming convention](../../../../knowledge/decisions/inspired-by-not-clones-naming.md). All v6.3 structural decisions carry forward unchanged. The renames: Magic 8-Ball → **Oracle Stone**, Hangman → **Cipher**, Mastermind → **Locksmith**, Battleship → **Sonar**, Tic-Tac-Toe → **Three in a Row**, Hunt the Wumpus → **The Caverns**, Hammurabi → **Yearfall**, Pong → **Volley**, Asteroids → **Drift**, Frogger → **Quickstep**, Pac-Man → **The Hungry Maze**. All marked first-draft, needs-workshop. Source of truth: changelog entry below, plus `memory/spectrum-basic-v6.4-reframe.md` and `knowledge/decisions/spectrum-basic-v6.4-renames.md`.
>
...
|---|---|------|------------------------|---------------|
| 1 | V1 | Banner | **Output** — the first program speaks | — |
