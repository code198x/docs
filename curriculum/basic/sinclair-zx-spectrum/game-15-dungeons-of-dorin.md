...
| 24 | Combat Polish | Add combat messages: "The rat bites you for 3 damage", "You strike the troll for 5 damage", "The goblin misses!" Show weapon and armour names in combat text. Colour-code damage (red for player, green for monster). | Descriptive combat text, string building, colour feedback |
| 25 | Danger Scaling | Adjust difficulty curves. Floors 1-3 are gentle (few weak monsters, frequent potions). Floors 7-9 are brutal (many strong monsters, scarce healing). Floor 10 is the gauntlet. Playtest and tune. | Difficulty curves, playtesting, balance tuning |
| 26 | Sound | Add BEEP effects: a short tone when moving, a hit sound in combat, a different tone for taking damage, a rising tone for collecting treasure, a low tone for death. Keep durations minimal to avoid slowing the game. | Sound design in a turn-based game, BEEP timing |
