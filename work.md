...
**Status: Meet BASIC, Bright Spark, Volley, Touchdown, Sonar, Crates, Tail Chase, Brick Bash and Drift published; Quickstep prototyping.** All fifteen Meet BASIC lessons and seven replacement Bright Spark lessons are live. Meet BASIC → Bright Spark is published. The agreed continuation is Volley → Touchdown. Volley’s approved eight lessons and overview are integrated into the website. See the [Meet BASIC implementation record](platforms/sinclair-zx-spectrum/basic/meet-basic-plan.md) and [Bright Spark verification record](platforms/sinclair-zx-spectrum/games/bright-spark/prototype.md). Native control/audio and independent learner observations remain useful Bright Spark follow-up work.
...
The user chose **Quickstep’s crossing-and-timing direction** after Drift. The [bounded prototype brief](platforms/sinclair-zx-spectrum/games/quickstep/brief.md) defines a larger board, six predictable vehicle lanes, one halfway resting strip and a marked exit. The [execution record](platforms/sinclair-zx-spectrum/games/quickstep/prototype.md) covers independent ROM entry, fresh tape loads, model checks and ordinary-frame crossing/control trials. The first native trial worked but was too easy and too small; a larger six-lane revision passes the execution checks and is open for another play review. A finished scope, lesson count and later continuation are not yet agreed.
