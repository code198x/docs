...
Publish the approved [Touchdown overview and eleven lessons](platforms/sinclair-zx-spectrum/games/touchdown/lessons.md) with the verified samples, eleven-unit catalogue, legacy redirects and onward links. Then review the next BASIC game brief and the remaining sequence together; subsequent BASIC and assembly choices remain proposals.
