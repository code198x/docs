...
Review the [Touchdown overview and eleven lesson drafts](platforms/sinclair-zx-spectrum/games/touchdown/lessons.md). Sixteen game checkpoints and a separate keyboard diagnostic implement the agreed progression. Check whether the easier vertical and wide-pad stages prepare learners for the final site, and whether lessons 4 and 7 explain their larger changes comfortably. Execution success alone does not establish teaching pace. Publish after lesson approval, preserving existing URLs and updating the catalogue and onward links together. Keep subsequent BASIC and assembly choices as proposals for joint review.
