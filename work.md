...
The four current-course groups are agreed and implemented in the website catalogue. The [remaining-course review](platforms/sinclair-zx-spectrum/basic/course-review.md) assesses all six earlier games and eleven proposals, including conflicting Night Patrol descriptions and four possible sequel consolidations. Next discuss its recommendation for a bounded Locksmith brief; no new prototype, retirement or replacement lineup is approved.
