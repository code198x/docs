...
- **RISC OS 5:** relicensed under Apache 2.0 in October 2018 (by RISC OS Developments with RISC OS Open; OSnews, and the reviewed `companies/acorn-computers`). Later than the Archimedes-era Arthur and RISC OS 2, which were not released (`systems/acorn-archimedes`).
