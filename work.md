...
Batch 5 continues down the list of unreviewed entries that lessons and patterns link to most: `hardware/paula`, `hardware/apu`, `hardware/copper`, `techniques/stable-raster`, `hardware/cia`, `hardware/amiga-chipset` and `hardware/6510`, then `hardware/agnus` and `hardware/6809`, which reviewed entries now link to.
