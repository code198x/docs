...
- **Atari coin-op (Ed Logg):** historicalsource published the 6502 source of *Asteroids*, the cocktail version and *Asteroids Deluxe*, and Logg's *Super Breakout*, *Video Pinball*, *Centipede* and *Millipede* (October 2021), plus the Atari 7800 *Asteroids* (April 2019); no licence stated (`games/asteroids`, `people/ed-logg`).
...
- **Design Design:** Simon Brattel's Z80 sources for *Halls of the Things*, *Dark Star*, *Forbidden Planet*, *Tank Busters* and others, Graham Stafford's for *2112*, *Kat Trap*, *Nosferatu* and more, and a free PC Zeus assembler, at desdes.com (updated May 2025); "all rights reserved", so ask before reusing (`companies/design-design`).
