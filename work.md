...
Review and play the [eight-checkpoint Volley prototype](platforms/sinclair-zx-spectrum/games/volley/prototype.md), built from the accepted [brief](platforms/sinclair-zx-spectrum/games/volley/brief.md). Maintained sources and verification live in the sample repository; the website still has a coming-soon entry and no Volley lessons. Use play observations and the checkpoint/concept comparison to decide whether to confirm Volley before Touchdown.
