...
The user chose **Quickstep’s crossing-and-timing direction** after Drift. The [bounded prototype brief](platforms/sinclair-zx-spectrum/games/quickstep/brief.md) defines one board, three predictable vehicle lanes, safe waiting strips and a marked exit. The [execution record](platforms/sinclair-zx-spectrum/games/quickstep/prototype.md) covers independent ROM entry, fresh tape loads, model checks and ordinary-frame crossing/control trials. The native preview is ready for user review of readable patterns, response and difficulty. A finished scope, lesson count and later continuation are not yet agreed.
