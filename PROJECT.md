...
The user-approved [editable BASIC browser integrations](platforms/sinclair-zx-spectrum/basic/browser-trial.md) are published in Meet BASIC and Sonar with no build flag. They use the browser API released with Meet Assembly. A whole-course BASIC retrofit remains a separate decision.
