...
The user selected [Yearfall](platforms/sinclair-zx-spectrum/games/yearfall/brief.md) next and authorised economy reconciliation and a bounded BASIC prototype: one settlement, people/grain/land, a combined editable plan and a ten-year run. The [executed trial](platforms/sinclair-zx-spectrum/games/yearfall/prototype.md) makes costs, labour and year-end changes explicit; 32 native checks and ten host model groups pass. Native acceptance and replacement lessons remain pending.
