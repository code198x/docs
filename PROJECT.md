...
The user selected [Dice Roller](platforms/sinclair-zx-spectrum/games/dice-roller/brief.md), the final unchanged published BASIC project, for a compact native probability experiment. The authorised first scope compares bounded batches, exact counts and proportions on a fixed screen scale, with live results as the rolls arrive. The user approved the live native prototype. The user authorised its compact teaching sequence and runnable checkpoints. The [five-stage teaching specification](platforms/sinclair-zx-spectrum/games/dice-roller/lesson-brief.md) follows that accepted endpoint; the user authorised website authoring, and the overview and five replacement lessons are prepared locally for review.
