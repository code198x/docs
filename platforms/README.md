...
| ZX Spectrum | [Quickstep](sinclair-zx-spectrum/games/quickstep/brief.md) | Six-lane BASIC baseline accepted; overview and ten lessons authored and locally verified; [review pending](sinclair-zx-spectrum/games/quickstep/lessons.md) |
