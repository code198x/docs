...
| ZX Spectrum | [Three in a Row](sinclair-zx-spectrum/games/three-in-a-row/brief.md) | BASIC prototype implemented; 40 execution checks passed; native acceptance pending |
