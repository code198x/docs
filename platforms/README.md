...
| ZX Spectrum | [Locksmith](sinclair-zx-spectrum/games/locksmith/brief.md) | BASIC baseline accepted; seven [executed checkpoints](sinclair-zx-spectrum/games/locksmith/lessons.md) for nine authored replacement lessons; local checks pass, user lesson review pending |
