...
**Status:** The user selected The Caverns after the recommendation to trial a small authored cave with useful warnings and deliberate evasion. The concrete rules below define the first implementation for native play, not an accepted final game or lesson sequence. Earlier published lessons remain unchanged.
