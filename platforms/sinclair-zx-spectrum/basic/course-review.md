...
3. The user selected Cipher and subsequently authorised its compact lesson sequence; the six approved lessons with five verified checkpoints are published in Boards and deduction. Dice Roller’s live prototype and compact five-stage teaching sequence are approved; the overview and five replacement lessons are published in Optional experiments. No retained published BASIC project remains unchanged from this review.
