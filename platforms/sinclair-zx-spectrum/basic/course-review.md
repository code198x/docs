...
2. Three in a Row’s opponent review is complete; its native prototype is accepted and ten replacement lessons are published. The user selected The Caverns next; its bounded exploration prototype is under development. Yearfall remains a later candidate for contrasting persistent state.
