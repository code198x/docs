...
- [`knowledge/curriculum/shadowkeep-32-unit-plan.md`](../curriculum/shadowkeep-32-unit-plan.md) — full per-unit specifications.
- [`knowledge/curriculum/revamp.md`](../curriculum/revamp.md) — live status tracker.
