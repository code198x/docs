...
> **AMENDED 2026-06-10 (lineup replan) — game lineups recorded.** Both tracks now have an
> applied coming-soon lineup (catalogue authoritative:
> `website/src/content/modules/commodore-amiga/{amos,blitz}.yaml`). The peer-paths rule below is
> unchanged — neither lineup ranks the tracks; each climaxes on its own strengths.
>
